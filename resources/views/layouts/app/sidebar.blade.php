    ...
    <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Seguridad')" class="grid">
                @can('roles:view')
                <flux:sidebar.item icon="shield-check" :href="route('admin.security.roles')" :current="request()->routeIs('admin.security.roles')" wire:navigate>
                    {{ __('Roles y Permisos') }}
                </flux:sidebar.item>
                @endcan
                
                @can('users:view')
                <flux:sidebar.item icon="users" :href="route('admin.security.users')" :current="request()->routeIs('admin.security.users')" wire:navigate>
                    {{ __('Usuarios') }}
                </flux:sidebar.item>
                @endcan
            </flux:sidebar.group>
