...
new #[Title('Productos')] class extends Component {
    ...
    public function products()
    {
        ...
        switch ($this->sort) {
            ...
            default:
                $seed = (int) date('Ymd');
                $query->orderByRaw('discount_percentage > 0 DESC')
                      ->inRandomOrder($seed);
                break;
        }

        return $query->with(['brand', 'images'])->paginate(24);
    }
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-8">
        ...
        <div class="mb-2 md:mb-4 overflow-hidden">
            <flux:breadcrumbs class="flex-wrap gap-y-1">
                <flux:breadcrumbs.item href="{{ route('tienda') }}" icon="home" wire:navigate
                ...
                <div
                    ...
                    <div class="hidden lg:flex items-center gap-3">
                        ...
                        <flux:select wire:model.live="sort" class="w-48 border !border-gray-400 ">
                            <flux:select.option value="recommended">Recomendados</flux:select.option>
