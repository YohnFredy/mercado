...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        'primary' => 'bg-[var(--color-primary)] hover:bg-[color-mix(in_oklab,_var(--color-primary),_transparent_20%)]',
        'secondary' => 'bg-[var(--color-secondary)] hover:bg-[color-mix(in_oklab,_var(--color-secondary),_transparent_20%)]',
        'acento' => 'bg-[var(--color-acento)] hover:bg-[color-mix(in_oklab,_var(--color-acento),_transparent_20%)]',
    ...
    ->add(match ($variant) { // Text color...
        'primary' => 'text-[var(--color-fondo)]',
        'secondary' => 'text-[var(--color-fondo)]',
        'acento' => 'text-[var(--color-fondo)]',
    ...
    ->add(match ($variant) { // Border color...
        ...
        'acento' => 'border border-black/10 dark:border-0',
    ...
    ->add(match ($variant) { // Shadows...
        'primary' => 'shadow-[inset_0px_1px_theme(--color-white/.2)]',
        'secondary' => 'shadow-[inset_0px_1px_theme(--color-white/.2)]',
        'acento' => 'shadow-[inset_0px_1px_theme(--color-white/.2)]',
    ...
    ->add(match ($variant) { // Grouped border treatments...
        ...
        'primary' => '[[data-flux-button-group]_&]:border-e-0 [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-[1px] dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-0 dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-s-[1px] [:is([data-flux-button-group]>&:not(:first-child),_[data-flux-button-group]_:not(:first-child)>&)]:border-s-[color-mix(in_srgb,var(--color-primary),transparent_85%)]',
        'secondary' => '[[data-flux-button-group]_&]:border-e-0 [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-[1px] dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-0 dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-s-[1px] [:is([data-flux-button-group]>&:not(:first-child),_[data-flux-button-group]_:not(:first-child)>&)]:border-s-[color-mix(in_srgb,var(--color-secondary),transparent_85%)]',
        'acento' => '[[data-flux-button-group]_&]:border-e-0 [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-[1px] dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-0 dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-s-[1px] [:is([data-flux-button-group]>&:not(:first-child),_[data-flux-button-group]_:not(:first-child)>&)]:border-s-[color-mix(in_srgb,var(--color-acento),transparent_85%)]',
    })
